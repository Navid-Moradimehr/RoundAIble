...
/**
 * Fallback copy of the backend provider catalog (GET /api/providers is the
 * live source). Kept so the UI works even if the backend hasn't started yet.
 */
...
export function getProviderDef(providers: ProviderDef[], id?: string): ProviderDef | undefined {
